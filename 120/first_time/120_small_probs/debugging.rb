...
#   def ==(other_geolocation)
#     latitude == other_geolocation.latitude && longitude == other_geolocation.longitude
#   end
# end
...
# #  there is no == method defined in the geolocation class
...
#     # rescue Exception # this is a problem because it is rescuing all exceptions
#     #   NoScore
#     end
#   end
...
#     binding.pry
#     case score
#     when NoScore # this is a problem because it is not equating score with no score
#       "No idea about #{term}..."
#     when 0...0.5
#       "#{term} is not fun."
#     when 0.5
